                    ...
                    <div class="row">
                        <div class="col col-lg-12">
                            <form action="/" class="o-form d-none d-md-block">
                                @csrf
                                <div class="o-form__search" action="{{route('search')}}" method="POST">
                                    <label for="jmp-header-search">{{ __('Search Products') }}</label>
                                    @csrf
                                    <input name="query" type="search" id="jmp-header-search" placeholder="Search products..." aria-label="Search Products">
