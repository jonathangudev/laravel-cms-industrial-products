                ...
                <div class="col">
                    <nav class="c-header__nav">
                        <ul class="c-header__mobile-list">
                            <li class="c-header__mobile-item"><a href="#" class="c-header__link is-active">Home</a></li>
                            <li class="c-header__mobile-item"><a href="#" class="c-header__link">About Us</a></li>
                            <li class="c-header__mobile-item"><a href="#" class="c-header__link">Our Products &amp; Services</a></li>
                            <li class="c-header__mobile-item"><a href="#" class="c-header__link">Contact Us</a></li>
